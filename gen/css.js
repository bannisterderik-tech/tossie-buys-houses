...
@media(max-width:760px){
  ...
  /* the promise line can't fit next to the phone at this width — phone wins */
  .topbar .wrap{justify-content:center;gap:0;font-size:.8rem;overflow:visible}
  .topbar .wrap > span{display:none}
  .topbar a{display:block;text-align:center;padding:2px 0}
}
